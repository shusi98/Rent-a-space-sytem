...
if(isset($_GET['pid']) && !empty($_GET['pid']))
{
	...
	$_SESSION["findThisProperty"] = $propId = mysqli_real_escape_string($con,$_GET["pid"]);

	$image = "";
	
	if(!$con->connect_error)
	{
		$stmt = $con->prepare("select property.PropertyID,PropertyName,Vaccant,Description,Rent,Address,Province,City,Image from property,image where Visible = 'Yes' and property.PropertyID = ? and property.PropertyID = image.PropertyID");
	...
	<div class="container">
		...
		<div class="d-flex" style="margin-top:15px;">
			<ul class="breadcrumb">
				...
				<li><a href="availProps.php">Available Spaces</a></li>
		...
		if($numReturnedRows > 0)
		{
			...
			echo '<div class="d-flex"	style="margin-top:15px;"><a href="applyToOccupy.php?pid='.$_SESSION["findThisProperty"].'"><button>Apply to occupy this property</button></a></div>';
		}
		else
		{
